    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h2 className="text-3xl font-bold text-foreground tracking-tighter">New Project</h2>
                    <p className="text-muted-foreground text-sm font-medium mt-1">Plan and structure your team's next big initiative.</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="grid gap-2.5">
                                <Label className="font-semibold text-xs text-foreground px-0.5">Visibility</Label>
                                <div className="flex bg-muted/60 border border-border/60 p-1 rounded-lg shadow-sm">
                                    <button type="button" className="flex-1 py-2 text-xs font-semibold rounded-lg bg-primary text-primary-foreground shadow-sm">Private</button>
                                    <button type="button" className="flex-1 py-2 text-xs font-medium rounded-lg text-muted-foreground hover:text-foreground">Public</button>
                                </div>
                            </div>
                        </div>

                        <div className="grid gap-2.5">
                            <Label htmlFor="description" className="font-semibold text-xs text-foreground px-0.5">Project Overview & Objectives</Label>
                            <Textarea
                                id="description"
                                placeholder="What are the key goals, milestones, and success metrics for this project?"
                    ...
                    <div className="pt-8 border-t border-border/40 flex items-center justify-end gap-4">
                        ...
                        <Button type="submit" className="bg-primary hover:bg-primary text-primary-foreground font-semibold px-8 h-11 rounded-lg shadow-sm active:scale-95 transition-all text-sm cursor-pointer">
                            Create Project
                        </Button>
                    </div>
                </form>
